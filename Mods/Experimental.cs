    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Admin Mods (admins only) [23]
                ...
                new ButtonInfo { buttonText = "Asset Bundles", method =() => CurrentCategoryName = "AssetBundles", isTogglable = false, toolTip = "All the assetbundles."},
            ...
            {
                new ButtonInfo { buttonText = "Exit AssetBundles", method =() => CurrentCategoryName = "AssetBundles", isTogglable = false, toolTip = "Returns you back to the Admin mods."},
                ...
                new ButtonInfo { buttonText = "Ban Hammer", isTogglable = true, method = Experimental.BanHammer, disableMethod = Experimental.DestoryBanHammer},
                new ButtonInfo { buttonText = "Sherbert", isTogglable = true, method = Experimental.SpawnSherbert, disableMethod = Experimental.KillSherbert},
                new ButtonInfo { buttonText = "Sherbert Follow", isTogglable = true, method = Experimental.SherbertFollow, disableMethod = Experimental.StopSherbertFollow},
            },
